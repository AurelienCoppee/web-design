...
const AddEventFAB: VoidComponent<AddEventFABProps> = (props) => {
    return (
        <button
            ...
            class="fixed bottom-6 right-6 bg-primary-container text-on-primary-container rounded-mat-corner-full h-14 px-6 flex items-center justify-center gap-3 shadow-mat-level3 hover:brightness-110 active:scale-95 transition-transform duration-150 ease-out" // Changed to rounded-mat-corner-full
