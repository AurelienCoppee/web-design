...
const AddEventFAB: VoidComponent<AddEventFABProps> = (props) => {
    return (
        <button
            ...
            class="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 bg-primary-container text-on-primary-container rounded-full h-14 px-4 sm:px-6 flex items-center justify-center gap-3 shadow-mat-level3 hover:brightness-110 active:scale-95 transition-transform duration-150 ease-out"
